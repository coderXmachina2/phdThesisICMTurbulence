...
\title{Constraining Turbulence in the Intracluster Medium with the Radio Sunyaev Zeldovich Effect}

%***YOUR NAME***
%Do not include initials or middle names. Do not include your supervisor(s)' name(s).
\author{AFIQ ABDUL HAMID}
...
%CHAPTER 1
\input{./Chapter1/scientificLandscape.tex}

%CHAPTER 2
\input{./Chapter2/assumptions&TransferEffects.tex}

\input{./Chapter3/MethodsAndProcedures.tex}
